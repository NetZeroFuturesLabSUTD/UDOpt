...
class MixedVariableProblem(ElementwiseProblem):
    ...
    def _evaluate(self, X, out, *args, **kwargs):
        ...
        try: # MAIN TRY EXCEPT
            ...
            scalarized_score = sum([(value - metric_bounds[key][0]) / (metric_bounds[key][1] - metric_bounds[key][0]) for key, value in UDS['Evaluations'].items()])
            UDS['Evaluations']['ScalarizedScore'] = scalarized_score
