...
def main(UDS):
    ...
    for i,BF in enumerate(UDS['Features']['BuildingFootprints']):
        ...
        if BF['properties']['building'] == 'residential':
            ...
            context_properties = GetContextProperties(UDS['Features']['BuildingFootprints'], i, ray_length=255, ray_qty=10) # SM trained on 255 and 10. do not change parameters.
            ...
            UDS['Features']['BuildingFootprints'][i]['properties']['ApproxAnnualEUI'] = y_pred
    
    UDS['Evaluations']['TotalApproxAnnualEUI'] = sum([BF['properties']['ApproxAnnualEUI'] for BF in UDS['Features']['BuildingFootprints'] if 'ApproxAnnualEUI' in BF['properties']])
    return UDS